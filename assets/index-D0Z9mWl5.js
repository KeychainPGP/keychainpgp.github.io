(async ()=>{
    ...
    var Lr = Array.isArray, gi = Array.prototype.indexOf, Mt = Array.prototype.includes, fr = Array.from, yi = Object.defineProperty, Wt = Object.getOwnPropertyDescriptor, bi = Object.getOwnPropertyDescriptors, mi = Object.prototype, wi = Array.prototype, _n = Object.getPrototypeOf, Ur = Object.isExtensible;
    const xi = ()=>{};
    function ki(e) {
    ...
    const me = 2, _r = 4, dr = 8, vn = 1 << 24, nt = 16, Ye = 32, It = 64, Er = 128, Fe = 512, pe = 1024, we = 2048, $e = 4096, Ce = 8192, st = 16384, St = 32768, Lt = 65536, $r = 1 << 17, pn = 1 << 18, Kt = 1 << 19, Ei = 1 << 20, ot = 1 << 25, At = 65536, Sr = 1 << 21, Cr = 1 << 22, lt = 1 << 23, Bt = Symbol("$state"), Si = Symbol(""), yt = new class extends Error {
    ...
    function wn(e) {
        if (e !== null) for (const t of e)(t.f & me) === 0 || (t.f & At) === 0 || (t.f ^= At, wn(t.deps));
    }
    function xn(e, t, r) {
        (e.f & we) !== 0 ? t.add(e) : (e.f & $e) !== 0 && r.add(e), wn(e.deps), se(e, pe);
    }
    const rr = new Set;
    let X = null, Ar = null, We = null, Te = [], vr = null, Tr = !1, Ut = !1;
    class ct {
        current = new Map;
        previous = new Map;
        #t = new Set;
        ...
        process(t) {
            ...
            if (this.#u()) {
                this.#f(n), this.#f(r);
                for (const [i, o] of this.#i)An(i, o);
            } else {
                for (const i of this.#t)i();
                this.#t.clear(), this.#e === 0 && this.#d(), Ar = this, X = null, Yr(n), Yr(r), Ar = null, this.#r?.resolve();
            }
            We = null;
        }
        #c(t, r, n) {
            ...
            for(var i = t.first; i !== null;){
                var o = i.f, a = (o & (Ye | It)) !== 0, s = a && (o & pe) !== 0, l = s || (o & Ce) !== 0 || this.#i.has(i);
                if (!l && i.fn !== null) {
    ...
    function qi(e) {
        ...
        try {
            for(var r;;){
                if (Vi(), Te.length === 0 && (X?.flush(), Te.length === 0)) return vr = null, r;
                kn();
            }
        } finally{
            Ut = t;
    ...
    function Yr(e) {
        ...
        if (t !== 0) {
            for(var r = 0; r < t;){
                var n = e[r++];
                if ((n.f & (st | Ce)) === 0 && er(n) && (Qe = new Set, zt(n), n.deps === null && n.first === null && n.nodes === null && n.teardown === null && n.ac === null && Fn(n), Qe?.size > 0)) {
                    ut.clear();
                    for (const i of Qe){
    ...
    function En(e, t, r, n) {
        if (!r.has(e) && (r.add(e), e.reactions !== null)) for (const i of e.reactions){
            const o = i.f;
            (o & me) !== 0 ? En(i, t, r, n) : (o & (Cr | nt)) !== 0 && (o & we) === 0 && Sn(i, t, n) && (se(i, we), Be(i));
        }
    }
    function Sn(e, t, r) {
        const n = r.get(e);
    ...
    function Be(e) {
        ...
        for(; t.parent !== null;){
            t = t.parent;
            var n = t.f;
            if (Tr && t === Y && (n & nt) !== 0 && (n & pn) === 0 && (n & St) !== 0) return;
            if ((n & (It | Ye)) !== 0) {
                if ((n & pe) === 0) return;
                t.f ^= pe;
            }
    ...
    function An(e, t) {
        if (!((e.f & Ye) !== 0 && (e.f & pe) !== 0)) {
            ...
            for(var r = e.first; r !== null;)An(r, t), r = r.next;
        }
    }
    function Bi(e) {
        let t = 0, r = Tt(0), n;
    ...
    class Yi {
        ...
        #h(t) {
            var r = Y, n = W, i = Ge;
            Je(this.#r), qe(this.#r), Ct(this.#r.ctx);
            try {
                return t();
            } catch (o) {
                return mn(o), null;
        ...
        update_pending_count(t) {
            this.#y(t), this.#u += t, !(!this.#_ || this.#f) && (this.#f = !0, Dt(()=>{
                this.#f = !1, this.#_ && Nt(this.#_, this.#u);
            }));
        }
        get_effect_pending() {
    ...
    function Xi() {
        ...
        return function(o = !0) {
            Je(e), qe(t), Ct(r), o && n?.activate();
        };
    }
    function Pr(e = !0) {
        Je(null), qe(null), Ct(null), e && X?.deactivate();
    }
    function Ji() {
    ...
    function Zi(e, t, r) {
        Y === null && Ti();
        var i = void 0, o = Tt(be), a = !W, s = new Map;
        return ho(()=>{
            var l = dn();
            i = l.promise;
            try {
            ...
            const f = (h, g = void 0)=>{
                if (u.activate(), g) g !== yt && (o.f |= lt, Nt(o, g));
                else {
                    (o.f & lt) !== 0 && (o.f ^= lt), Nt(o, h);
                    for (const [_, w] of s){
    ...
    function Pn(e) {
        ...
        Pt || (We !== null ? (Kr() || X?.is_fork) && We.set(e, t) : Nr(e));
    }
    function ro(e) {
    ...
    function p(e, t, r = !1) {
        W !== null && (!Ue || (W.f & $r) !== 0) && yn() && (W.f & (me | nt | Cr | $r)) !== 0 && (Ve === null || !Mt.call(Ve, e)) && Ci();
        let n = r ? rt(t) : t;
        return Nt(e, n);
    }
    function Nt(e, t) {
    ...
    function Rn(e, t) {
        ...
        if (r !== null) for(var n = r.length, i = 0; i < n; i++){
            ...
            if (s && se(o, t), (a & me) !== 0) {
                var l = o;
                We?.delete(l), (a & At) === 0 && (a & Fe && (o.f |= At), Rn(l, $e));
            ...
            set (s, l, u, d) {
                ...
                if (N?.set && N.set.call(d, u), !h) {
                    if (n && typeof l == "string") {
                        var P = r.get("length"), M = Number(l);
                        Number.isInteger(M) && M >= P.v && p(P, M + 1);
                    }
                    $t(i);
                }
                return !0;
    ...
    function vt(e, t, r) {
        ...
        var o = i;
        if (r && o.deps === null && o.teardown === null && o.nodes === null && o.first === o.last && (o.f & Kt) === 0 && (o = o.first, (e & nt) !== 0 && (e & Lt) !== 0 && o !== null && (o.f |= Lt)), o !== null && (o.parent = n, n !== null && _o(o, n), W !== null && (W.f & me) !== 0 && (e & It) === 0)) {
            var a = W;
            (a.effects ??= []).push(o);
        }
        return i;
    ...
    function Vn(e, t, r) {
        if ((e.f & Ce) === 0) {
            ...
            for(var i = e.first; i !== null;){
                var o = i.next, a = (i.f & Lt) !== 0 || (i.f & Ye) !== 0 && (e.f & nt) !== 0;
                Vn(i, t, a ? r : !1), i = o;
            }
        }
    }
    ...
    function $n(e) {
        ...
        Pe = null, Me = 0, ze = null, W = (u & (Ye | It)) === 0 ? e : null, Ve = null, Ct(e.ctx), Ue = !1, Et = ++mt, e.ac !== null && (zr(()=>{
            e.ac.abort(yt);
        }), e.ac = null);
        try {
            e.f |= Sr;
            ...
            if (Pe !== null) {
                var _;
                if (g || Zt(e, Me), h !== null && Me > 0) for(h.length = Me + Pe.length, _ = 0; _ < Pe.length; _++)h[Me + _] = Pe[_];
                else e.deps = h = Pe;
                if (Kr() && (e.f & Fe) !== 0) for(_ = Me; _ < h.length; _++)(h[_].reactions ??= []).push(e);
            } else !g && h !== null && Me < h.length && (Zt(e, Me), h.length = Me);
            ...
            e.f ^= Sr, Pe = t, Me = r, ze = n, W = i, Ve = o, Ct(a), Ue = s, Et = l;
        }
    }
    function wo(e, t) {
        let r = t.reactions;
        ...
        if (r === null && (t.f & me) !== 0 && (Pe === null || !Mt.call(Pe, t))) {
            var o = t;
            (o.f & Fe) !== 0 && (o.f ^= Fe, o.f &= ~At), Nr(o), ro(o), Zt(o, 0);
        }
    }
    function Zt(e, t) {
        var r = e.deps;
    ...
    function c(e) {
        ...
        if (W !== null && !Ue) {
            ...
            if (!n && (Ve === null || !Mt.call(Ve, e))) {
                var i = W.deps;
                if ((W.f & Sr) !== 0) e.rv < mt && (e.rv = mt, Pe === null && i !== null && i[Me] === e ? Me++ : Pe === null ? Pe = [
                    e
                ] : Pe.push(e));
                else {
                    (W.deps ??= []).push(e);
        ...
        var l = void 0, u = po(()=>{
                ...
                for(var _ = 0; _ < g.length; _++){
                    ...
                    if (!f.has(w)) {
                        ...
                        for (const E of [
                            ...
                            var M = P.get(w);
                            M === void 0 ? (E.addEventListener(w, tn, {
                                passive: N
                            }), P.set(w, 1)) : P.set(w, M + 1);
                        }
                    }
                }
            };
            return h(fr(Jn)), Or.add(h), ()=>{
                for (var g of f)for (const N of [
                    ...
                    --w == 0 ? (N.removeEventListener(g, tn), _.delete(g), _.size === 0 && nr.delete(N)) : _.set(g, w);
                }
    ...
    function pr(e, t, r, n, i, o = null) {
        ...
        var u = null, d = Qi(()=>{
            var N = r();
            return Lr(N) ? N : N == null ? [] : fr(N);
        }), f, h = !0;
        function g() {
            w.fallback = u, Co(w, f, a, t, n), u !== null && (f.length === 0 ? (u.f & ot) === 0 ? Gr(u) : (u.f ^= ot, Gt(u, null, a)) : kt(u, ()=>{
                u = null;
            }));
        }
        var _ = Fr(()=>{
            f = c(d);
            for(var N = f.length, P = new Set, M = X, E = Cn(), L = 0; L < N; L += 1){
                var C = f[L], K = n(C, L), F = h ? null : s.get(K);
                F ? (F.v && Nt(F.v, C), F.i && Nt(F.i, L), E && M.unskip_effect(F.e)) : (F = No(s, h ? a : rn ??= ft(), C, K, L, i, t, r), h || (F.e.f |= ot), s.set(K, F)), P.add(K);
            }
            if (N === 0 && o && !u && (h ? u = Ke(()=>o(a)) : (u = Ke(()=>o(rn ??= ft())), u.f |= ot)), N > P.size && Pi(), !h) if (E) {
                for (const [H, Se] of s)P.has(H) || M.skip_effect(Se.e);
                M.oncommit(g), M.ondiscard(()=>{});
            } else g();
            c(d);
        }), w = {
            effect: _,
    ...
    function Co(e, t, r, n, i) {
        ...
        for(w = 0; w < o; w += 1){
            ...
            if ((_.f & Ce) !== 0 && Gr(_), _ !== s) {
                if (l !== void 0 && l.has(_)) {
                    if (d.length < f.length) {
                        var P = f[0], M;
                        u = P.prev;
                        var E = d[0], L = d[d.length - 1];
                        for(M = 0; M < d.length; M += 1)Gt(d[M], P, r);
                        for(M = 0; M < f.length; M += 1)l.delete(f[M]);
    ...
    function No(e, t, r, n, i, o, a, s) {
        var l = (a & _i) !== 0 ? (a & vi) === 0 ? no(r, !1, !1) : Tt(r) : null, u = (a & di) !== 0 ? Tt(i) : null;
        return {
            v: l,
            i: u,
            e: Ke(()=>(o(t, l ?? r, u ?? i, s), ()=>{
...
Enjoy using KeychainPGP!`, Ps = "Language", Is = {
    ...
    async function cl(e, t) {
        const r = await fi(), n = new Uint8Array(Array.from(atob(t), (a)=>a.charCodeAt(0))), i = new Uint8Array(Array.from(atob(e), (a)=>a.charCodeAt(0))), o = await crypto.subtle.decrypt({
            name: "AES-GCM",
            iv: n
        }, r, i);
    ...
    function Pl(e, t) {
        ...
        async function L() {
            ...
            try {
                ...
                await Mr(x.fingerprint, I.user_ids[0]?.name ?? null, I.user_ids[0]?.email ?? null, x.public_key, x.secret_key), p(d, x.public_key, !0), p(f, x.fingerprint, !0), p(u, !0);
            ...
            var j = (x)=>{
                ...
                var I = gl(), G = et(I), Z = v(G), oe = b(G, 2), de = v(oe), ge = b(oe, 2);
                {
                    var le = (re)=>{
                        ...
                        D((ae, xe, Rt, br)=>{
                            Oe(Q, "placeholder", ae), Oe(ue, "placeholder", xe), Oe(fe, "placeholder", Rt), ye.disabled = c(l), m(Ae, br);
                        }, [
                            ()=>y("keygen_name"),
                            ()=>y("keygen_email"),
                            ()=>y("keygen_passphrase"),
                            ()=>c(l) ? y("onboarding_gen_generating") : y("onboarding_gen_btn")
                        ]), Le(Q, ()=>c(i), (ae)=>p(i, ae)), Le(ue, ()=>c(o), (ae)=>p(o, ae)), Le(fe, ()=>c(a), (ae)=>p(a, ae)), J("click", ye, L), T(re, ce);
                    };
                    $(ge, (re)=>{
                        c(u) ? re(le) : re(je, !1);
                    });
    ...
    function Nl(e, t) {
        ...
        var f = Cl(), h = v(f), g = v(h), _ = b(h, 2), w = b(_, 2), N = v(w), P = v(N), M = b(N, 2);
        {
            var E = (V)=>{
                var A = Il(), j = v(A);
                D((z)=>m(j, z), [
                ...
                var A = Dl();
                pr(A, 21, ()=>c(o), (j)=>j.fingerprint, (j, z)=>{
                    var te = Rl();
                    let _e;
                    ...
                    ]), J("change", Ne, ()=>l(c(z).fingerprint)), T(j, te);
                }), T(V, A);
            };
            $(M, (V)=>{
                c(o).length === 0 ? V(E) : V(L, !1);
            });
        }
        ...
        D((V, A, j, z, te)=>{
            m(g, V), Oe(_, "placeholder", A), m(P, j), C.disabled = z, m(K, te);
        }, [
            ()=>y("encrypt_title"),
            ...
            ()=>!c(r).trim() || c(a).size === 0,
            ()=>y("encrypt_btn")
        ]), Le(_, ()=>c(r), (V)=>p(r, V)), J("click", C, u), T(e, f), dt();
    }
    Ot([
        "change",
        "click"
    ...
    function Fl(e, t) {
        ...
        async function a() {
            ...
            const L = (await tr()).filter((C)=>C.isOwn);
            if (L.length === 0) {
        ...
        D((E, L, C, K, F)=>{
            m(d, E), Oe(f, "placeholder", L), Oe(h, "placeholder", C), g.disabled = K, m(_, F);
        }, [
            ()=>y("decrypt_title"),
            ...
            ()=>!c(r).trim(),
            ()=>y("decrypt_btn")
        ]), Le(f, ()=>c(r), (E)=>p(r, E)), Le(h, ()=>c(n), (E)=>p(n, E)), J("click", g, a), T(e, l), dt();
    }
    Ot([
        "click"
    ]);
    ...
    function Xl(e, t) {
        ...
        async function a() {
            ...
            for (const M of P)try {
                const E = el(c(r), M.publicKey);
                if (E.valid) {
                    p(n, {
                        valid: !0,
                        fingerprint: E.signer_fingerprint
                    }, !0), p(i, M.name ?? M.email ?? M.fingerprint.slice(-16), !0);
                    return;
                }
            } catch  {}
            p(n, {
        ...
        D((P, M, E, L)=>{
            m(u, P), Oe(d, "placeholder", M), f.disabled = E, m(h, L);
        }, [
            ()=>y("verify_title"),
            ()=>y("verify_placeholder"),
            ()=>!c(r).trim(),
            ()=>y("verify_btn")
        ]), Le(d, ()=>c(r), (P)=>p(r, P)), J("click", f, a), T(e, s), dt();
    }
    Ot([
        "click"
    ]);
    ...
    function sc(e, t) {
        ...
        async function w() {
            ...
            try {
                ...
                await Mr(R.fingerprint, B.user_ids[0]?.name ?? null, B.user_ids[0]?.email ?? null, R.public_key, R.secret_key), await _(), p(n, !1), p(o, ""), p(a, ""), p(s, ""), p(g, y("keygen_success"), !0), setTimeout(()=>p(g, ""), 3e3);
            } catch (R) {
                p(l, String(R), !0);
            } finally{
                p(u, !1);
        ...
        async function N() {
            ...
            try {
                ...
                await Mr(R.fingerprint, B, U, c(d), x), await _(), p(i, !1), p(d, ""), p(g, y("import_success", {
        ...
        var z = b(A, 2);
        {
            var te = (R)=>{
                ...
                ]), Le(I, ()=>c(o), (Q)=>p(o, Q)), Le(G, ()=>c(a), (Q)=>p(a, Q)), Le(Z, ()=>c(s), (Q)=>p(s, Q)), J("click", le, ()=>p(n, !1)), J("click", re, w), T(R, B);
            };
            $(z, (R)=>{
                c(n) && R(te);
            });
        ...
        var _e = b(z, 2);
        {
            var Ne = (R)=>{
                ...
                ]), Le(I, ()=>c(d), (re)=>p(d, re)), J("click", de, ()=>p(i, !1)), J("click", le, N), T(R, B);
            };
            $(_e, (R)=>{
                c(i) && R(Ne);
            });
            ...
            var pt = (R)=>{
                ...
                pr(B, 21, ()=>c(r), (U)=>U.fingerprint, (U, x)=>{
                    ...
                    D((ye, Ae, ae, xe)=>{
                        ...
                        ()=>y("key_export_btn"),
                        ()=>y("key_delete_btn")
                    ]), J("click", ue, ()=>M(c(x))), J("click", q, ()=>P(c(x).fingerprint)), T(U, I);
                }), T(R, B);
            };
            $(He, (R)=>{
    ...
    function pc(e, t) {
        ...
        u();
        var d = vc(), f = et(d), h = v(f), g = b(v(h), 4);
        pr(g, 21, ()=>Yt, (A)=>A.code, (A, j)=>{
            var z = lc(), te = v(z), _e = {};
            D(()=>{
        ...
        var E = b(h, 4), L = v(E), C = b(f, 2);
        {
            var K = (A)=>{
                ...
                D((q, Ee, ye, Ae, ae)=>{
                    ...
                    ()=>y("tab_verify"),
                    ()=>y("tab_keys")
                ]), J("click", Ne, ()=>p(i, "encrypt")), J("click", Xe, ()=>p(i, "decrypt")), J("click", U, ()=>p(i, "sign")), J("click", G, ()=>p(i, "verify")), J("click", de, ()=>p(i, "keys")), T(A, j);
            };
            $(C, (A)=>{
        ...
        D((A, j, z, te)=>{
            _ !== (_ = A) && (g.value = (g.__value = A) ?? "", ei(g, A)), Oe(w, "title", j), m(L, z), m(V, te);
        }, [
            Ns,
            ()=>c(o) === "light" ? y("theme_light") : y("theme_dark"),
            ()=>y("app_subtitle"),
            ()=>y("app_footer")
        ]), J("change", g, l), J("click", w, s), T(e, d), dt();
    }
    Ot([
        "change",
        "click"
